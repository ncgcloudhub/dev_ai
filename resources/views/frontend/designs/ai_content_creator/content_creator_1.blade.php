    ...
    <div class="container">
        ...
        <div class="row align-items-center gy-4">
            ...
            <div class="mx-auto d-flex justify-content-center">
                @auth
                    <a href="{{ route('aicontentcreator.manage') }}" class="btn gradient-btn-5">Show More</a> <!-- Redirect to user.prompt.library if user is a normal user -->
                @else
                    <a href="{{ route('frontend.free.aicontentcreator') }}" class="btn gradient-btn-5">Show More</a> <!-- Redirect to frontend.free.prompt.library if no one is logged in -->
                @endauth
            </div>
        </div>
        <!-- end row -->
