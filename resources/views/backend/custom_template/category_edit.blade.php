...
<a href="{{ route('custom.template.category.add') }}" class="btn waves-effect waves-light gradient-btn-add mb-3" title="Add Category"><i class="{{$buttonIcons['add']}}"></i>
</a>
            ...
            <div class="card-body">
                ...
                <div class="live-preview">
                    <form  action="{{ route('custom.template.category.update') }}" method="post" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="text-end">
                                <button class="btn btn-rounded gradient-btn-save mb-2" title="Update"><i class="{{$buttonIcons['save']}}"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
