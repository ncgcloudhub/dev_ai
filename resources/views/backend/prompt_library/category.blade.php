...
@section('title') Prompt Category Add @endsection
@section('content')
            ...
            <div class="card-body">
                ...
                <div class="live-preview">
                    <form action="{{ route('prompt.category.store') }}" method="post" class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="text-end">
                                <button class="btn btn-rounded gradient-btn-save mb-2 disabled-on-load" disabled title="Save"><i class="{{$buttonIcons['save']}}"></i></button>
                            </div>
                        </div>
                    </form>
                </div>
