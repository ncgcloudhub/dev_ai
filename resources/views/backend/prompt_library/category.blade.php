    ...
    <div class="col-xxl-6">
        ...
        <div class="card">
            <div class="card-header align-items-center d-flex">
                <h4 class="card-title mb-0 flex-grow-1">Prompt Library Category Add<a href="{{ route('prompt.manage') }}" class="btn text-white badge-gradient-primary mx-1 ">Library</a> <a href="{{ route('prompt.subcategory.add') }}" class="btn text-white badge-gradient-primary mx-1 ">Sub-Category</a></h4>
            </div><!-- end card header -->
