...
<a href="{{ route('prompt.category.add') }}" class="btn waves-effect waves-light btn-primary mb-3">Add Category
</a>
                ...
                <div class="live-preview">
                    <form  action="{{ route('prompt.category.update') }}" method="post" class="row g-3">
                        ...
                        <div class="form-floating">
                            <input type="text" name="category_name" class="form-control" value="{{$category->category_name}}" id="category_name" placeholder="Enter Category">
